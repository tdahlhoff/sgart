...
public final class RerouteItemHandler {
     ...
     * @throws ItemNotReroutableApplicationException if the list is not {@code IN_TRIP} (409)
     */
    public void handle(
        ...
        } catch (ItemNotReroutableException notReroutable) {
            throw new ItemNotReroutableApplicationException(notReroutable.getMessage());
        }
