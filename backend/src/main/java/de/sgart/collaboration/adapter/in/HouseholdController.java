 ...
 * caller's households by name for the 0/1/≥2 routing decision. The caller identity comes only
 * from the JWT {@code sub} via {@link AuthenticatedCaller} — never from the request body (AR10,
 * AD-5); {@code SecurityConfig} already secures {@code /api/v1/**}.
 */
@RestController
...
class HouseholdController {
    ...
    HouseholdController(CreateHouseholdHandler createHouseholdHandler, ListMyHouseholds listMyHouseholds) {
