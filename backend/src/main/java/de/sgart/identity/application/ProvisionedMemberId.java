...
/**
 * The outcome of {@link MintMemberIdentity#provision}: the caller's {@link MemberId} together with
 ...
 * #freshlyProvisioned()} to decide whether a compensating {@link MintMemberIdentity#retract} is
