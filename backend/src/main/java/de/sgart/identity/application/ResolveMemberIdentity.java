 ...
 * A query use case: it never issues or writes, only translates the caller's Keycloak identity into
 ...
 *
 * <p>Like {@link IssueMemberIdentity#issue} and {@link ListHouseholdsForCaller#forCaller}, the
