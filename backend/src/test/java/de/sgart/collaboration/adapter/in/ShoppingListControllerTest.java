...
class ShoppingListControllerTest {
    ...
    void list_returns200WithTheOpenLists() throws Exception {
        ...
        shoppingListReadModel.put(
                householdId, List.of(new ShoppingListView(listId, new ShoppingListName("Getränke"), ListStatus.OPEN, 0, null)));
    ...
    void list_returnsOnlyTheCallersHouseholdLists() throws Exception {
        ...
        shoppingListReadModel.put(
                otherHousehold,
                List.of(new ShoppingListView(ShoppingListId.generate(), new ShoppingListName("Fremd"), ListStatus.OPEN, 0, null)));
    ...
    void getWithDoneFilterReturnsTheCallersDoneLists() throws Exception {
        ...
        shoppingListReadModel.put(
                householdId,
                List.of(new ShoppingListView(doneId, new ShoppingListName("Alte Liste"), ListStatus.DONE, 0, null)));
    ...
    void anotherHouseholdsDoneListsAreExcludedFromTheArchive() throws Exception {
        ...
        shoppingListReadModel.put(
                otherHousehold,
                List.of(new ShoppingListView(ShoppingListId.generate(), new ShoppingListName("Fremd"), ListStatus.DONE, 0, null)));
