...
void main() {
  group('HttpInvitesApi', () {
    test('createInvite_postsTheCorrectPathAndBodyShape', () async {
      ...
      await api.createInvite('household-1', inviteId: 'invite-1', commandId: 'command-1');
    ...
    test('createInvite_mapsAServerErrorToAnAppException', () async {
      final dio = Dio(BaseOptions(baseUrl: 'https://backend.example.test'));
      ...
      await expectLater(
        api.createInvite('household-1', inviteId: 'invite-1', commandId: 'command-1'),
